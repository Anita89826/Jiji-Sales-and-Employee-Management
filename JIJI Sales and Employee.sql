...
-- JOIN Clause: 
-- Retrieve employee names and their corresponding positions.
select * from employees;
...
-- combine using UNION (as in combining results from multiple tables)
SELECT OrderID AS ID, TotalAmount AS Amount FROM Orders
UNION
SELECT EmployeeID AS ID, Salary AS Amount FROM Employees;
